...
- [ ] **⚠️ Beschreibungstexte für die Arbeiten — jetzt sichtbar dringend.** Das neue Flanken-Layout (2026-09-13) setzt den Text zwischen die Bilder. Mit einem Satz („Beschreibung folgt.") laufen die Flanken weit unter den Text hinaus und die Mitte ist eine leere Rinne. Das Layout ist nicht falsch, es hat schlicht nichts zu zeigen. **Zwei bis vier Absätze je Arbeit von Jakob** — dann trägt es. ⚠️ Nichts erfinden; bis dahin bleibt der ehrliche Platzhalter stehen.
