...
| Bildstrecke → **Mosaik** | Die Bilder der Strecke stehen **unter dem Text** als Zeilensatz: Zeilen gleicher Höhe, die Breite jedes Bildes folgt seinem Seitenverhältnis, beide Ränder bündig. **Kein Bild wird beschnitten** — das ist der ganze Zweck, denn eine Strecke mischt Hoch- und Querformat (bei `wiwawo-53` fünf zu zwei). ⚠️ **Gerechnet wird in CSS, nicht in JavaScript:** jede Kachel bekommt `flex-grow: ar` und `flex-basis: ar × Zeilenhöhe`. Weil Zuwachs und Grundbreite **beide** am Seitenverhältnis hängen, bleibt die Breite jedes Bildes zu `ar` proportional und die Zeilenhöhe damit für alle gleich — ohne eine einzige Messung. Ein gemessener Satz (`ResizeObserver`) täte dasselbe, wäre aber ohne Skript leer und beim ersten Bild sichtbar am Springen. **Mobil** ein Bild je Zeile. ⚠️ **Ersetzt die Flanken** (2026-09-13, nur einen Tag alt) und davor den Filmstreifen. Jan, als Hero, Flanken und Kontaktbogen dieselben Bilder dreimal zeigten: „das ist zu viel des guten“ — und er hat recht: Die Flanken kosteten sechs volle Bildschirme und zeigten nichts, was das Mosaik nicht zeigt. **Was dabei verloren geht und bewusst hingenommen ist:** Die Flanken waren die einzige Stelle, an der ein Bild groß und unausweichlich war; im Mosaik entscheidet der Besucher per Klick, welches Bild groß wird. Nebenbei fällt damit die alte Grenze weg, dass das Layout an der Textlänge hing. |
