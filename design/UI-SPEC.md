...
| Auslieferung | WebP mit `srcset` in bis zu fünf Breiten (480–2400), AVIF bis 1600, ein JPEG als Rückfall, `width`/`height` am `img` gegen Layoutsprünge. Erzeugt von `npm run medien` aus dem R2-Bucket, **nicht** im Deploy; Regeln in `lib/bilder-regeln.mjs`, Bedienung in `TECH-STACK.md`, Abschnitt „Medien". |
