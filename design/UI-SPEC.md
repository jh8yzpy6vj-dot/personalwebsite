...
| Leitbild (Detailseite) | **Ohne Zuschnitt** — das Bild bringt seine Form mit, begrenzt wird die **Höhe** (`72svh`, mobil `56svh`), auf schwarzem Grund zentriert. ⚠️ **Geändert am 2026-09-12; vorher `height: 72vh` + `object-fit: cover`.** Beim ersten echten Hochformat (2000×3000) fiel auf, was das anrichtet: Auf einem 1920×1080-Schirm ist die Box 1920×778, das Bild wird auf 1920×2880 skaliert und auf 778 px beschnitten — sichtbar sind **27 % des Fotos**, ein Querstreifen durch die Mitte. Dazu fordert der Browser 1920 CSS-px an (Retina 3840) und bekommt 1600 — 2,4-fach hochgerechnet. Ohne Zuschnitt ist dasselbe Hochformat nur noch ~519 CSS-px breit, die vorhandene 1200er-Stufe deckt das auf Retina mit Reserve ab: **ganzes Bild, scharf, und ein Bruchteil der Bytes.** Die Regel folgt damit derselben Begründung wie beim Porträt eine Zeile tiefer. |
